...
//https://github.com/Microsoft/DataConnectors/blob/master/docs/m-extensions.md#example-connector-with-required-parameters
   TestConnection = (dataSourcePath) =>
    ...
    Authentication =[
        Key=[
        KeyLabel = "Copy API Access token from BI360",
        Label ="BI360 Access Token"
        ]
    ] ,
     Label ="Authenticate to BI360"
];
...
BI360Impl = (url as text) as table =>
    let
        ...
        withData = Table.AddColumn(rename, "Data", each BI360.View(_url,Text.Format("#[label]",_),Text.Format("#[shortLabel]",_)),type table),
...
BI360.Publish = [
    ...
    SourceImage = BI360.Icons,
    SourceTypeImage = BI360.Icons
];

BI360.Icons = [
    Icon16 = { Extension.Contents("BI36016.png"), Extension.Contents("BI36020.png"), Extension.Contents("BI36024.png"), Extension.Contents("BI36032.png") },
    Icon32 = { Extension.Contents("BI36032.png"), Extension.Contents("BI36040.png"), Extension.Contents("BI36048.png"), Extension.Contents("BI36064.png") }
];
...
BI360Type = type function(
    Url as (type text meta [
        Documentation.FieldCaption = "Api Url", //this is the title for the text box
        Documentation.FieldDescription = "The API Url from BI360"
    ]))
     as table meta [
        Documentation.Name = "URL from BI360", //this is what shows up on the URL screen as a title
